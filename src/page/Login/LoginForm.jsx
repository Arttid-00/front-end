        ...
        <div class="h-full">
          ...
          <div class="flex h-full flex-wrap items-center justify-center lg:justify-between">
            <div class="shrink-1 mb-12 grow-0 basis-auto md:mb-0 md:w-9/12 md:shrink-0 lg:w-6/12 xl:w-6/12">
              <img
                src="src\page\Login\img\logo.png"
                class="w-full"
                alt="Sample image"
              />
            </div>
            ...
            <div class="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
              <form>
                ...
                <div class="text-center lg:text-left">
                  <button
                    type="button"
                    class="inline-block w-full rounded bg-green-500 px-7 pb-2 pt-3 text-sm font-medium uppercase leading-normal text-white shadow-primary-3 transition duration-150 ease-in-out hover:bg-green-700 hover:shadow-primary-2 focus:bg-green-700 focus:shadow-primary-2 focus:outline-none focus:ring-0 active:bg-green-700 active:shadow-primary-2 dark:shadow-black/30 dark:hover:shadow-dark-strong dark:focus:shadow-dark-strong dark:active:shadow-dark-strong"
                    data-twe-ripple-init
                    data-twe-ripple-color="light"
                  >
                    Login
